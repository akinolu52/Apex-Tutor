<?php $__env->startSection('title', 'Apex Tutor Menu'); ?>
                ...
                <div class="mbr-navbar__container">
                    <div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                        <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline">
                            <span class="mbr-brand__logo"><img src="<?php echo e(URL::to('images/apex2.png')); ?>" class="mbr-navbar__brand-img mbr-brand__img"></span>
                            ...
                            <div class="mbr-navbar__column">
                                <ul class="mbr-navbar__items mbr-navbar__items--right float-left mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active mbr-buttons--only-links">
                                    <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="#" style="color:#FFF">
                                        <img src="<?php echo e(URL::to('images/APEX_Learning_USER_ICON2.png')); ?>" style="height:30px; padding-bottom:10px;"> 
                                        <font style="font-size:20px;">
                                            Username </font><font size="+3" style="font-weight:bold"> 50
                                        </font>
                                    </a></li>
                                    <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="#" style="color:#FFF">
                                    <img src="<?php echo e(URL::to('images/GOLD_MEDAL.png')); ?>" style="height:30px; padding-bottom:5px; padding-left:1.12%">7</a></li>
                                    <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="#" style="color:#FFF">
                                    <img src="<?php echo e(URL::to('images/SILVER_MEDAL.png')); ?>" style="height:30px; padding-bottom:5px; padding-left:1.12%">10</a></li>
                                    <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="#" style="color:#FFF">
                                    <img src="<?php echo e(URL::to('images/BRONZE_MEDAL.png')); ?>" style="height:30px; padding-bottom:5px; padding-left:1.12%;">3</a></li>
                                    <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="#"on  style="color:#FFF">
                                    <img src="<?php echo e(URL::to('images/LOGOUT_ICON.png')); ?>" style="height:30px; padding-bottom:10px padding-left:30px"></a></li>  
                                </ul>
                            </div>
                        </nav>
                    </div>
...
<?php $__env->startSection('content'); ?>
    <section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header4-3" style="background-image: url(<?php echo e(URL::to('images/background.jpg')); ?>)">
                        ...
                        <div class="container grid" style="width:71%; padding:0px; margin:0px; margin-top:-60px; margin-left:auto; margin-right:auto;">
                            <div class="grid" style="width:80%; margin-left:auto; margin-right:auto">
                                    <div class="row no_pad no_mag" style="margin-left:auto; margin-right:auto">
                                        ...
                                        <img src="<?php echo e(URL::to('images/APEX_Learning_PRACTISE_HEADER.png')); ?>"  style="height:110px">
                                    </div>
                                    <div class="row no_pad no_mag" style="margin-left:auto; margin-right:auto">
                                    ...
                                    <div class="row no_pad no_mag" style="margin-left:auto; margin-right:auto">
                                        ...
                                        <?php
                                            ...
                                            for($i = 0; $i < count($c); $i++){ ?>
                                                <b><a href="<?php echo e(URL::to('menu/practise')); ?>/<?= $c[$i]; ?>">
